...
│
│❒͡  _*CHIKA BOT*_ 
│❒͡ *OWNER* : _*${authorStick}*_ 
│❒͡ *Contact My Owner*
│ *https://wa.me/${owner}*
│❒͡ *Time: ${time}*
│❒͡ *STATUS* :「 ${public} 」
│❒͡ *Prefix :「 MULTI 」*
│❒͡ *Menuju Idul Adha 1442H*
│❒͡ *${cekRamadhan}*
│❒͡ *Join Group Chika*
│ *Klik Link Dibawah:*
│❮ \`\`\`https://cutt.ly/kl3ue8K\`\`\` ❯
│
╰── 「 *CHIKA BOT* 」 ──
...
Aliases: -
Usage: *${prefix}metallic* teks

36. *${prefix}hacker*
Teks dengan efek hekelmen.
Aliases: -
Usage: *${prefix}hacker* teks

37. *${prefix}quotemaker*
Buat quotemaker text.
Aliases: -
Usage: *${prefix}quotemaker* teks

38. *${prefix}quotemaker2*
Buat quotemaker text.
Aliases: -
Usage: *${prefix}quotemaker2* teks

39. *${prefix}goldbutton*
Teks dengan fake goldplay button.
Aliases: -
Usage: *${prefix}playbutton* teks

40. *${prefix}silverbutton*
...
66. *${prefix}summersand*
Teks dengan efek pantai.
Aliases: -
Usage: *${prefix}summersand* teks

67. *${prefix}horrortext*
...
70. *${prefix}christmastext*
Teks dengan efek natal.
Aliases: -
Usage: *${prefix}christmastext* teks

71. *${prefix}watercolor*
Teks dengan efek wc.
Aliases: -
Usage: *${prefix}watercolor* teks
...
Aliases: -
Usage: *${prefix}wetglass* teks

74. *${prefix}luxurygold*
Teks maker effect.
Aliases: -
Usage: *${prefix}luxurygold* teks

75. *${prefix}galaxywall*
Teks dengan efek galaxy.
Aliases: -
Usage: *${prefix}galaxywall* teks

76. *${prefix}valentine*
Teks dengan efek love valentine.
Aliases: -
Usage: *${prefix}valentine* teks

77. *${prefix}heartshaped*
Teks dengan efek.
Aliases: -
Usage: *${prefix}heartshaped* teks

78. *${prefix}caketext*
Teks dengan efek kue.
Aliases: -
Usage: *${prefix}caketext* teks

79. *${prefix}konsertext*
Teks dengan efek asap konser..
Aliases: -
Usage: *${prefix}konsertext* teks

80. *${prefix}galaxystyle*
Teks dengan efek.
Aliases: -
Usage: *${prefix}galaxystyle* teks

81. *${prefix}hologram3d*
Teks dengan efek 3d hologram.
Aliases: -
Usage: *${prefix}hologram3d* teks

82. *${prefix}glussytext*
Teks dengan efek.
Aliases: -
Usage: *${prefix}glussytext* teks

83. *${prefix}greenbush*
Teks dengan efek.
Aliases: -
Usage: *${prefix}greenbush* teks

84. *${prefix}metallogo*
Teks dengan efek metal.
Aliases: -
Usage: *${prefix}metallogo* teks

85. *${prefix}noellogo*
Teks dengan efek noel.
Aliases: -
Usage: *${prefix}noellogo* teks

86. *${prefix}glittertext*
Teks dengan efek pisau.
Aliases: -
Usage: *${prefix}glittertext* teks

87. *${prefix}cookiestext*
Teks dengan efek biskuit.
Aliases: -
Usage: *${prefix}cookiestext* teks

88. *${prefix}startext*
Teks dengan efek rasi bintang.
Aliases: -
Usage: *${prefix}startext* teks

89. *${prefix}woodentext*
Teks dengan efek pahatan kayu.
Aliases: -
Usage: *${prefix}woodentext* teks

90. *${prefix}snow3d*
Teks dengan efek salju.
Aliases: -
Usage: *${prefix}snow3d* teks

91. *${prefix}ff*
Teks dengan efek logo freefire random.
Aliases: -
Usage: *${prefix}ff* teks

92. *${prefix}textname*
Teks dengan efek.
Aliases: -
Usage: *${prefix}textname* teks

93. *${prefix}galaxywtr*
Teks dengan efek galaxy.
Aliases: -
Usage: *${prefix}galaxywtr* teks

94. *${prefix}galaxybat*
Teks dengan efek galaxy.
Aliases: -
Usage: *${prefix}galaxybat* teks

95. *${prefix}birthdaytext*
Teks dengan efek perayaan ulang tahun.
Aliases: -
Usage: *${prefix}birthdaytext* teks

96. *${prefix}candlemug*
Teks dengan efek permen.
Aliases: -
Usage: *${prefix}candlemug* teks

97. *${prefix}mugflower*
Teks dengan efek bunga.
Aliases: -
Usage: *${prefix}mugflower* teks

98. *${prefix}romancetext*
Teks latar love.
Aliases: -
Usage: *${prefix}romancetext* teks

99. *${prefix}grass*
Teks dengan efek.
Aliases: -
Usage: *${prefix}grass* teks

100. *${prefix}lovepaper*
Teks dengan efek.
Aliases: -
Usage: *${prefix}lovepaper* teks

101. *${prefix}coffee*
Teks dengan efek.
Aliases: -
Usage: *${prefix}coffee* teks

102. *${prefix}woodheart*
Teks dengan efek.
Aliases: -
Usage: *${prefix}woodheart* teks

103. *${prefix}wolfmetal*
Teks dengan efek metal
Aliases: -
Usage: *${prefix}wolfmetal* teks

104. *${prefix}summer3d*
Teks dengan efek hutan.
Aliases: -
Usage: *${prefix}summer3d* teks

105. *${prefix}glowingneon*
Teks dengan efek.
Aliases: -
Usage: *${prefix}glowingneon* teks

106. *${prefix}summernature*
Teks dengan efek.
Aliases: -
Usage: *${prefix}summernature* teks

107. *${prefix}ukir*
Teks dengan efek ukiran.
Aliases: -
Usage: *${prefix}ukir* teks

108. *${prefix}flamming*
Teks dengan efek flamming fire.
Aliases: -
Usage: *${prefix}flamming* teks

109. *${prefix}fallleaves*
Teks dengan efek musim gugur.
Aliases: -
Usage: *${prefix}fallleaves* teks

110. *${prefix}lolbanner*
Teks dengan efek banner game LoL.
Aliases: -
Usage: *${prefix}lolbanner* teks

111. *${prefix}woodenflower*
Teks dengan efek bunga.
Aliases: -
Usage: *${prefix}woodenflower* teks

112. *${prefix}underwater*
Teks dengan efek air laut.
Aliases: -
Usage: *${prefix}underwater* teks

113. *${prefix}nature3d*
Teks dengan efek nature.
Aliases: -
Usage: *${prefix}nature3d* teks

114. *${prefix}battlefield4*
Membuat teks dengan style logo game b4.
Aliases: -
Usage: *${prefix}battlefield4* teks_atas | teks_bawah

115. *${prefix}gravity*
Membuat teks dengan style gravity.
Aliases: -
Usage: *${prefix}gravity* teks_atas | teks_bawah

116. *${prefix}codwarzone*
Membuat teks dengan style logo game CoD.
Aliases: -
Usage: *${prefix}codwarzone* teks_1 | teks_2

117. *${prefix}juventus*
Membuat teks dengan style juventus jersey.
Aliases: -
Usage: *${prefix}juventus* teks_nama | teks_angka

118. *${prefix}valorant*
Membuat teks dengan style logo game valorant.
Aliases: -
Usage: *${prefix}valorant* teks | nama_fb | nama_twt

119. *${prefix}goldrose*
Teks dengan efek mawar emas.
Aliases: -
Usage: *${prefix}goldrose* teks

120. *${prefix}erodedtext*
Teks dengan efek.
Aliases: -
Usage: *${prefix}erodedtext* teks

121. *${prefix}wings*
Teks dengan efek sayap galaxy.
Aliases: -
Usage: *${prefix}wings* teks

122. *${prefix}cartoongraffiti*
Teks dengan efek graffiti.
Aliases: -
Usage: *${prefix}cartoongraffiti* teks

123. *${prefix}graffiti*
Membuat teks dengan style graffiti.
Aliases: -
Usage: *${prefix}graffiti* teks_atas | teks_bawah

124. *${prefix}foil*
Teks dengan efek.
Aliases: -
Usage: *${prefix}foil* teks

125. *${prefix}matrix*
Teks dengan efek matrix.
Aliases: -
Usage: *${prefix}matrix* teks

126. *${prefix}browntext*
Teks dengan efek gelap.
Aliases: -
Usage: *${prefix}browntext* teks

127. *${prefix}padlock*
Membuat teks dengan style gembok.
Aliases: -
Usage: *${prefix}padlock* teks_1 | teks_2
    `
}
