...
const getCmd = (id) => {
    let position = null
    Object.keys(JSON.parse(fs.readFileSync('./database/scommand.json'))).forEach((i) => {
        if (JSON.parse(fs.readFileSync('./database/scommand.json'))[i].id === id) {
            position = i
        }
    })
    if (position !== null) {
        return JSON.parse(fs.readFileSync('./database/scommand.json'))[position].chats
    }
}
...
exports.serialize = (xinz, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.chats = (ane.type === 'conversation' && ane.conversation) ? ane.conversation : (ane.type == 'imageMessage') && ane.imageMessage.caption ? ane.imageMessage.caption : (ane.type == 'documentMessage') && ane.documentMessage.caption ? ane.documentMessage.caption : (ane.type == 'videoMessage') && ane.videoMessage.caption ? ane.videoMessage.caption : (ane.type == 'extendedTextMessage') && ane.extendedTextMessage.text ? ane.extendedTextMessage.text : (ane.type == 'listResponseMessage') && ane.listResponseMessage.singleSelectReply.selectedRowId ? ane.listResponseMessage.singleSelectReply.selectedRowId : (ane.type == 'templateButtonReplyMessage') && ane.templateButtonReplyMessage.selectedId ? ane.templateButtonReplyMessage.selectedId : (ane.type == 'stickerMessage') && (getCmd(ane.stickerMessage.fileSha256.toString('hex')) !== null && getCmd(ane.stickerMessage.fileSha256.toString('hex')) !== undefined) ? getCmd(ane.stickerMessage.fileSha256.toString('hex')) : ""
    ...
    msg.chats = (msg.type === 'conversation' && msg.message.conversation) ? msg.message.conversation : (msg.type == 'imageMessage') && msg.message.imageMessage.caption ? msg.message.imageMessage.caption : (msg.type == 'documentMessage') && msg.message.documentMessage.caption ? msg.message.documentMessage.caption : (msg.type == 'videoMessage') && msg.message.videoMessage.caption ? msg.message.videoMessage.caption : (msg.type == 'extendedTextMessage') && msg.message.extendedTextMessage.text ? msg.message.extendedTextMessage.text : (msg.type == 'listResponseMessage') && msg.message.listResponseMessage.singleSelectReply.selectedRowId ? msg.message.listResponseMessage.singleSelectReply.selectedRowId : (msg.type == 'templateButtonReplyMessage') && msg.message.templateButtonReplyMessage.selectedId ? msg.message.templateButtonReplyMessage.selectedId : (msg.type == 'stickerMessage') && (getCmd(msg.message.stickerMessage.fileSha256.toString('hex')) !== null && getCmd(msg.message.stickerMessage.fileSha256.toString('hex')) !== undefined) ? getCmd(msg.message.stickerMessage.fileSha256.toString('hex')) : ""
