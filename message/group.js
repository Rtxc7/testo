    ...
    if (anj.action === 'add'){
        if (anj.participants[0] === xinz.user.jid){
            ...
            const welcomer = await new canvas.Welcome()
                ...
                .toAttachment()
            xinz.sendMessage(anj.jid, welcomer.toBuffer(), MessageType.image, {caption: `Hai @${anj.participants[0].split("@")[0]}, selamat datang di ${groupName}`, contextInfo: {"mentionedJid": [anj.participants[0]]}})
        }
